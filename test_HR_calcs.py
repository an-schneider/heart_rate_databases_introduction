...
def test_hr_calcs():
    ...
    test_times = [datetime.datetime.strptime("2018-03-09 11:00:36.372339",
                                             time_format),
                  datetime.datetime.strptime("2018-03-09 18:00:44.413444",
                                             time_format),
                  datetime.datetime.strptime("2018-03-10 09:21:00.459253",
                                             time_format),
                  datetime.datetime.strptime("2018-03-10 20:45:47.545165",
                                             time_format),
                  datetime.datetime.strptime("2018-03-11 08:30:29.597243",
                                             time_format)]
    test_cutoff1 = datetime.datetime.strptime("2018-03-10 12:00:00.000000",
                                              time_format)
    test_cutoff2 = datetime.datetime.strptime("2018-03-10 20:45:48.000000",
                                              time_format)
